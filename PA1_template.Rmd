...
We see that the interval with the highest average number of steps is the interval with the number `r avgPerInterval[avgPerInterval$steps == max(avgPerInterval$steps),]$interval`.
